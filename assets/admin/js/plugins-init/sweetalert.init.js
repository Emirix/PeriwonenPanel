  ...
  for(var i = 0; i<document.querySelectorAll(".siparis-onaylandi").length;i++){
    document.querySelectorAll(".siparis-onaylandi")[i].onclick = function () {
      swal({
        title: "<span style='color:#2BC155'>Sipariş Onaylandı!</span>",
        text: "Hey, bu mesaj 2 saniye sonra kapanacak!!",
        timer: 2e3,
        showConfirmButton: !1,
      });
    }
